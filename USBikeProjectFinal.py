...
def get_filters():
    ...
    city = check_input("Which city would you like to see the data for? Please enter Chicago, New York City or Washington?",1)
    # get user input for month (all, january, february, ... , june)
    month = check_input("In which Month (January, ... June)? If you have no preference, you can enter 'all'.", 2)
    # get user input for day of week (all, monday, tuesday, ... sunday)
    day = check_input("On which day (Monday, Tuesday, ... Sunday)? If you have no preference, you can enter 'all'.", 3)
    print('-'*40)
...
def time_stats(df):
    ...
    print("\nThis took {}s seconds.".format(duration))
    print('-'*40)
